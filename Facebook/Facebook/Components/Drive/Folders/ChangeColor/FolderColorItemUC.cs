...
{
    public partial class FolderColorItemUC : UserControl
    {
        ...
        public static FolderColorItemUC CurrentItemUC;

        public FolderColorItemUC(ThemeColorItem theme, bool isActive = false)
        {
            InitializeComponent();
