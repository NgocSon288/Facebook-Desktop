...
{
    public partial class ShareThemColorItemUC : UserControl
    {
        public ThemeColorItem theme;
        private bool isActive;

        public static ShareThemColorItemUC CurrentItemUC;

        public ShareThemColorItemUC(ThemeColorItem theme, bool isActive = false)
        {
            InitializeComponent();
